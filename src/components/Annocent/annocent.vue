        ...
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item style="margin-bottom: 40px;" prop="title">
              <MDinput v-model="create.name" :maxlength="100" name="name" required>
                Url ini Giriniz
              </MDinput>
            </el-form-item>
            <el-form-item style="margin-bottom: 40px;" prop="title">
              <MDinput v-model="create.category" :maxlength="100" name="name" required>
                Kategorisi
              </MDinput>
            </el-form-item>
            <el-form-item style="margin-bottom: 40px;" prop="title">
...
export default {
  ...
  created() {
              ...
              this.create.name=this.pageL.data.name;
              this.create.category=this.pageL.data.category;
  ...
  methods: {
     createArticle(){
      ...
      this.$store.dispatch("page",this.create).then(res => {
         console.log(res);
        })
        }
        else{
          debugger;
          this.$store.dispatch("pageUpdate",this.create).then(res => {
         console.log(res);
        })
        }
    },
